            ...
            <div className="navbarPart">
                <Navbar color="light" light expand="md" className="pl-5 bg-transparent">
                    <NavbarBrand href={this.state.show ? null : "/"}><img className={this.state.show ? "d-none" : "d-block"} src="images/img.png" width="65" alt=""/>  <UncontrolledDropdown setActiveFromChild className={this.state.show ? "d-block" : "d-none"}>
                        <DropdownToggle className="bg-transparent border-0 shadow-none text-white pr-5"  caret>
                            UZ
                        </DropdownToggle>
                        <DropdownMenu>
                    ...
                    <Collapse isOpen={this.state.isOpen} navbar>
                        <Nav className="ml-auto mr-5" navbar>
                            <NavItem>
                                <Link to="/" className="link text-color mx-3 text-decoration-none">Home</Link>
                            </NavItem>

                            <NavItem>
                                <Link to="/services" className="link text-color mx-3 text-decoration-none">Services</Link>
                            </NavItem>
                            <NavItem>
                                <Link to="/ourTeam" className="link text-color mx-3 text-decoration-none">About us</Link>
                            </NavItem>
                            <NavItem>
                                <Link to="/portfolio" className="link text-color mx-3 text-decoration-none">Portfolio</Link>
                            </NavItem>
                            <NavItem>
                                <Link to="/contact" className="link text-color mx-3 text-decoration-none">Contact</Link>
                            </NavItem>
                            <div className={this.state.show ? "d-flex justify-content-center mt-5" : "d-none"} >
                                <div className="iconborder border mt-2 "><Link to="/" ><span className="icon iconfacebook "/></Link></div>
                                <div className={this.state.show ? "d-flex mx-4 iconborder my-2 p-1 border bg-transparent" : "d-none"} ><Link to="/"><span className="icon icontg"/></Link></div>
                        ...
                        <UncontrolledDropdown setActiveFromChild className={this.state.show ? "d-none" : "d-block"}>
                            <DropdownToggle className="bg-transparent shadow-none border-0 text-white pr-5"  caret>
                                UZ
                            </DropdownToggle>
                            <DropdownMenu>
                                <DropdownItem  href="/" >UZ</DropdownItem>
